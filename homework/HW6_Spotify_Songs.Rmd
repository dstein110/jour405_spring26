...
I think this data is slightly skewed left. The mean tells us that the average song in the dataset has a mean danceability of 0.67. The fact that the data set is skewed left demonstrates that the majority of songs in the data are danceable. My story pitch would be that the artist Gunna is on the top two most danceable songs on Spotify in 2020. Gunna's song "Fox 5" with Lil Keed ranked as the most danceable song, with a score of .975. In second place was Gunna and NAV's song "Codeine".
