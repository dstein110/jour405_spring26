...
```{r}
GDP_DJIA |> summarize(correlation = cor(DJIA, GDP, method="pearson"))
```
...
GDP_DJIA |> 
  ...
  labs(
    title = "Relationship between DJIA and GDP",
...
There is a strong positive correlation between the Dow Jones Industrial Average and the GDP of the U.S. According to the scatterplot, we can be fairly certain that DJIA has an effect on GDP and appears to be a significant factor. 
