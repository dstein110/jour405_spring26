...
ANSWER HERE
I would describe this distribution as roughly skewed right with three or four areas where salaries cluster. Salaries cluster around $65000, $115000, $150000 and $200000. If not for the large spike around $65000, the distribution maye be considered roughly normal excluding outliers. 
...
ANSWER HERE
The data roughly follows the empirical rule, as within 1 and 3 standard deviations are relatively close to the expected percentages. However, there is a roughly 5.5 percent difference between the expected percentage of values within 2 SDs and the actual percentage. This shows that the data thats within two standard deviations is not as normally distributed as the data on the high and low ends of the set.
...
ANSWER HERE
There is a 17 percent chance that a randomely selected White House employee makes more than $150,000. This is very close to the actual percentage which is 17.8. 
...
ANSWER HERE
This middle range tells us that approximately 35% of White House employees make between $80,000 and $120,000.
...
ANSWER HERE
The biggest differences between the normal distribution and reality are with salaries below $120,000. There are nearly 70 more employees with a salary between $60,000 and $90,000 than expected. However, there are conversely 41 less employees making less than $60,000. The small amount of employees making less than $60,000 could be explained by how expensive it is to live in the D.C. area.    
...
ANSWER HERE
Headline: Most White House employees making between $60-90 a year, data shows. 
Lede: If one of the 404 listed White House employees were randomly selected, there's only a 15 percent chance the employee makes more than $150,000 per year. But potentially more concerning is the number of employees making between $60 and 90,000 per year. The White House payroll has a significantly higher number of employees within this salary range than expected. 

I think that I could compare the probabilities in this data set to probabilities from previous presidential administrations. It would also be potentially helpful to see the percentages of employees at each salary bin. 
