...
ANSWER HERE
One anomaly is the steep decline in accidents in the beginning of 2020. This is likely because of the Covid pandemic forcing people to stay inside. Another anomaly is the steep increase in accidents at the end of 2021. One question I would look into is if the end of the Covid lockdowns coincide with this sharp increase in car accidents. Another possibility could be if the end of 2021 saw bad weather in PG County, which could be a cause of increased accidents. These visual patterns help find story angles because as reporters, we look for the patterns and outlying pieces of data, as they usually lead to stories. 
...
ANSWER HERE
According to the data, Friday and Saturday have the highest average number of accidents. Monday and Wednesday appear to have the lowest average accidents. I think these patterns exist because people are more likely to be out on the weekend, instead of at work. More people may be driving compared to on Monday, when most people are at work. 
...
ANSWER HERE
I looked into 5/29/21, which had an usually high number of accidents (50). I found that there was a thunderstorm in Maryland that day that caused high winds and rain. The day before, the National Weather Service advised the area may get up to a half inch of rain. The Washington Nationals also played a make-up doubleheader at home that night against the Brewers. I could incorporate these events into a potential story as factors contributing to a perfect storm of events that could've caused this spike in accidents. 
...
ANSWER HERE
These lists have some similarities, but the z-scores in the extreme day-of-week dataset are generally slightly lower than in the overall dataset. Only 4 of the dates in the extreme day-of-week dataset are also in the overall dataset, which gives us an idea on how to compare the two approaches. Reporters can compare all the unusual days on a balanced scale, but also can go a layer deeper and compare the unnusual days against the average only on that day, which could add to the strength of argument.
...
ANSWER HERE
According to the chart, May and October feature the highest average accidents, while January and March have the lowest average. I believe that the average number of accidents is lower in the winter because the cold weather leads to less people driving, whereas the warmer months in the Summer and Fall see higher levels of accidents because of more cors on the road. The Summer months especially may have more accidents because people are more often going on vacation and thus traveling to other places. As a result, there's more traffic and more accidents. 
...
ANSWER HERE
With the exception of two, all of the 12 days are Fridays or Saturdays.
...
I would do a story on how safety-related professionals prepare for high numbers of weekend accidents. I would talk to police officers, EMTs, physicians and people who work in emergency medicine, etc. I think it would be interesting to hear how much of a difference the day of the week creates in their jobs, as well as if there are any psychological effects of a sharp increase in accidents during weekends. 

Headline: Weekend Car Accidents Take Toll on PG County First Responders

The weekend is typically a time to put your feet up and gain much-needed rest after five days in the office. For first responders in Prince George's County, the weekend is where the work begins. According to dat from PG County, 10 of the 12 days with the highest numbers of accidents were Fridays or Saturdays.
