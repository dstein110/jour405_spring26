...
The voter category with the biggest difference between weighted and unweighted results is the always/never group who responded 'yes', with a 3.6% decrease after applying the weights.
2. How might these differences affect reporting on likely voter turnout?
This differences give reporters a different view of voter turnout, as they likely would anticipate a lower turnout, as a result of the lower percentages with the weights applied. 
...
These differences exist because different groups of voters, especially when pollsters are measuring enthusiasm, will have varying motivations to respond to polls. Unweighted polls might overrepresent peoeple who always vote because they are eager to vote and are proud of it. The larger the percentage difference with the weights applied, the more over/underrepresentation in the poll sample.
